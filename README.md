...
**Homepage** : download latest sources on [GitHub](https://github.com/cpainchaud/pan-configurator). Windows package with PHP binaries here: [dev.zip](https://paloaltonetworks.box.com/s/z1hwdyamump2wvdun9gv1dg42aiuuk79)
